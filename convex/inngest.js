...
// //here we will get the users who are in depth ,and this will be done by visiting 
// //expenses,

// import { query } from "./_generated/server";

// export const getUserWithOutstandingDebt = query({
//   handler:async ()=>{

//     //   const { groupId, userId } = args;
//       // Implementation would go here
//     //   return { groupId, userId };
//     const user=await ctx.db.query("userId").collect();
// const result=[];
