...
export function SplitSelector({
  ...
  const updateTotals = (currentSplits: Split[]) => {
  ...
  const updatePercentageSplit = (userId: string, newPercentage: string | number) => {
    const safePercentage = Math.max(0, Math.min(100, parseFloat(String(newPercentage)) || 0));
