...
const FeaturedIcon = ({ icon: Icon, color }: FeaturedIconProps) => (
...
const CheckListItem = ({ text, color }: CheckListItemProps) => (
...
const MockupWindow = ({ src, alt, align = "left" }: MockupWindowProps) => (
